  ...
  return (
    <section className="founder-section">
      ...
      <style jsx>{`
        ...
        .founder-info {
          position        : absolute;
          left            : calc(9% + min(50vw, 600px) + 32px);
          right           : 4%;
          top             : 60%;
        ...
        .quote-text {
          ...
          font-weight    : 400;
          /* FIXED: clamp(min, preferred, max) — min must be ≤ max */
          ...
          margin         : 0;
          text-align     : justify;
          /* Prevent ALL-CAPS rendering on font fallback */
          text-transform : none;
          font-variant   : normal;
        }
        ...
        @media (max-width: 1280px) {
          .founder-info {
            left : calc(9% + min(50vw, 600px) + 20px);
          }
          .quote-text { font-size: clamp(11px, 0.9vw, 14px); }
        }

        /* ── 1024px ── */
        @media (max-width: 1024px) {
          .founder-title  { font-size: clamp(60px, 10vw, 120px); left: 5%; }
          .founder-photo  { left: 4%; width: min(4vw, 380px); }
          .founder-info   {
            left  : calc(4% + min(42vw, 380px) + 24px);
            right : 3%;
          }
          .quote-text { font-size: clamp(11px, 1vw, 13px); line-height: 1.9; }
        }
        ...
        @media (max-width: 768px) {
          ...
          .quote-text   { font-size: clamp(13px, 3.2vw, 15px); line-height: 1.8; }
        }

        @media (max-width: 480px) {
          .founder-title { font-size: clamp(36px, 13vw, 56px); }
          .founder-name  { font-size: clamp(13px, 4vw, 18px); }
          .quote-text    { font-size: clamp(12px, 2.8vw, 14px); }
        }
