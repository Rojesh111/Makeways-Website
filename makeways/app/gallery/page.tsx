...
const galleryItems: GalleryItem[] = [
  ...
  { id: 2, title: 'Gold Award Win', category: 'AWARDS', src: '/images/awards/award2.webp' },
  { id: 3, title: 'Campaign Visual', category: 'PRINT', src: '/images/portfolio/static/goldstar.webp' },
  { id: 4, title: 'Social Campaign', category: 'DIGITAL', isVideo: true, ytId: 'X9ODmfPV8G4' },
  { id: 5, title: 'Brand Activation', category: 'EVENT', src: '/images/portfolio/static/padelux.webp' },
  { id: 6, title: 'Product TVC', category: 'TVC', isVideo: true, ytId: 'e8tvp4WzUiw' },
  { id: 7, title: 'OOH Billboard', category: 'PRINT', src: '/images/portfolio/static/yamaha.webp' },
  { id: 8, title: 'Influencer Series', category: 'DIGITAL', isVideo: true, ytId: '49f6uU2f9Ks' },
  { id: 9, title: 'Live Event Coverage', category: 'EVENT', src: '/images/activation/JCB.webp' },
  { id: 10, title: 'Best Agency Nepal', category: 'AWARDS', src: '/images/awards/Awards 1.webp' },
  { id: 11, title: 'Jingle Campaign', category: 'TVC', src: '/images/activation/Yamaha.webp' },
  { id: 12, title: 'Motion Graphics', category: 'DIGITAL', isVideo: true, ytId: 'WSdtEuZ9QsE' },
  { id: 13, title: 'Product Launch', category: 'EVENT', src: '/images/portfolio/static/himalayan reserve.webp' },
  { id: 14, title: 'Creative Excellence', category: 'AWARDS', src: '/images/awards/Awards 8.webp' },
  { id: 15, title: 'Festive Campaign', category: 'TVC', isVideo: true, ytId: 'b6OR_L1tSr8' },
  { id: 16, title: 'Newspaper Campaign', category: 'PRINT', src: '/images/portfolio/static/fiat1.webp' },
