...
export default function AboutMakeways(): ReactElement {
  ...
  /* ── H2 heading — Eurostile 700 · lh 1.15 · ls -0.01em ── */
  .about__heading {
    font-family    : var(--font-primary);
    font-weight    : 700;
    font-size      : clamp(40px, 3.75vw, 48px);
    /* FIXED: line-height 1.2 → 1.15 (H2 spec) */
    line-height    : 1.15;
  ...
  /* ── Award tag — EurostileCnd 700 · ls 0.1em (overline) ── */
  .about__award {
    display        : inline-flex;
    align-items    : center;
    gap            : 8px;
  ...
  /* ── Lead — Eurostile 400 · 16–18px · lh 1.65 · ls 0.01em ── */
  .about__lead {
    font-family    : var(--font-primary);
    font-weight    : 400;
  ...
  /* ── Body — Eurostile 400 · 16–18px · lh 1.7 · ls 0.01em ── */
  .about__body {
    font-family    : var(--font-primary);
    font-weight    : 400;
    font-size      : clamp(16px, 1.1vw, 18px);
    /* FIXED: line-height 1.6 → 1.7 */
    line-height    : 1.7;
    letter-spacing : 0.01em;
    color          : var(--mw-body);
    margin         : 0;
  ...
  .about__quote p {
    ...
    color          : #1a1a1a;
    margin         : 0;
    /* FIXED: added text-transform uppercase */
    text-transform : uppercase;
    /* FIXED: text-align justify → left */
    text-align     : left;
  }
