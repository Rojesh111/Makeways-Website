...
export default function Awards() {
  ...
  const prev = useCallback(() => {
    switchTo((activeIndex - 1 + awards.length) % awards.length);
  }, [activeIndex, switchTo]);

  const next = useCallback(() => {
    switchTo((activeIndex + 1) % awards.length);
  }, [activeIndex, switchTo]);
  ...
  return (
    <>
      <style>{`
        ...
        /* ══════════════════════════════════════════════
           ROOT — desktop side-by-side, mobile stacked
        ══════════════════════════════════════════════ */
        .aw-root {
          display    : flex;
          width      : 100%;
        ...
        /* ══════════════════════════════════════════════
           MOBILE — hidden by default, shown ≤ 768px
        ══════════════════════════════════════════════ */
        .aw-mob-header,
        .aw-mob-cert,
        .aw-mob-content {
        ...
        @media (max-width: 768px) {
          ...
          /* Reset root to natural stacking height */
          .aw-root {
            flex-direction : column;
            height         : auto;
            min-height     : unset;
          ...
          /* placeholder inside mobile cert */
          .aw-mob-cert .aw-placeholder {
            position : absolute;
            inset    : 0;
          }
          ...
          .aw-mob-arrow:hover { background: rgba(0,0,0,0.45); }
