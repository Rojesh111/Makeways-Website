...
/* ══════════════════════════════════════════
   SOCIAL BUTTON — SVG icon inside dark circle
══════════════════════════════════════════ */
  ...
  return (
    <>
      ...
      <footer className="ft" id="contact">
        ...
        {/* ══ MAIN ROW: contact (left) + socials + map (right) ══ */}
        <div className="ft__main-row">

          {/* ── LEFT: Brand + Contact with icons ── */}
          ...
          {/* ── RIGHT: Socials + Map stacked ── */}
          <div className="ft__right">

            {/* SOCIALS heading + SVG icon buttons */}
      ...
      <style jsx>{`
        ...
        .ft__navlink:hover { color: #F5A623; }
        ...
        /* ── RIGHT column — socials + map stacked ── */
        .ft__right {
          display       : flex;
          flex-direction: column;
        }

        /* ── SOCIALS — inside right column, above map ── */
        .ft__socials-row {
          display       : flex;
          align-items   : center;
          gap           : 18px;
        ...
        .ft__iframe-wrap iframe { width: 100%; height: 100%; display: block; border: 0; }
        ...
        .ft__map-cta:hover { background: #F5A623; color: #111; }
